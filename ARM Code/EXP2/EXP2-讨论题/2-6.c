...
uint8_t a=0,b=0,c=0,d=0,shi,fen,key1,key2,last1,last2;

//systick software counter define
volatile uint16_t systick_200ms_couter,systick_1000ms_couter; //10ms?100ms???
volatile uint8_t	systick_200ms_status,systick_1000ms_status; //10ms?100ms????
...
int main(void)
{
  ...
  IntMasterEnable();	//???????
	...
	while (1)
	{
		...
		if(systick_1000ms_status==1)//µ½ÁË1s
		{
			if (!key1&&!key2) d++;
			systick_1000ms_status=0;
		}
		if(	systick_200ms_status==1)
		{
			if(key1) d++;
			if(key2) b++;
