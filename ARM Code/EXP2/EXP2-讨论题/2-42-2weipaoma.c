...
volatile uint16_t systick_20ms_couter,systick_1000ms_couter; //10ms?100ms???
volatile uint8_t	systick_20ms_status,systick_1000ms_status; //10ms?100ms????
...
void SysTick_Handler(void)
{
	...
	if (systick_20ms_couter	== 0)
	{
		systick_20ms_couter	 = SYSTICK_FREQUENCY/50;
