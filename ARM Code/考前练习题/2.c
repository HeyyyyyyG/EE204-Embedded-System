...
volatile uint8_t lightup = 0x0AA;
...
int main(void)
{
  ...
  IntMasterEnable();		
	S800_GPIO_Init();
	S800_I2C0_Init();
	result = I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT1,0x0);						//write port 1 				
	result = I2C0_WriteByte(TCA6424_I2CADDR,TCA6424_OUTPUT_PORT2,0x0FF);
	...
	while (1)
	{
		  ...
		  switch (state)
	   {
			 case 1:
			 {
				 	result = I2C0_WriteByte(PCA9557_I2CADDR,PCA9557_OUTPUT,lightup);	
			    break;    }
			 case 2:
			 { 	
				 result = I2C0_WriteByte(PCA9557_I2CADDR,PCA9557_OUTPUT,~lightup);	
